			...
			<div class="login_header">
				...
				<div id="first">
					<form action="register.php" method="POST">
						<input type="email" name="log_email" placeholder="Email Address" required="" autofocus="" value="<?php if(isset($_SESSION['log_email'])) echo($_SESSION['log_email']) ?>">
						<br>
						...
						<br>
						<a href="#" id="signup" class="signup">Already have an account? Sign up here</a>
					</form>
				</div>
				...
				<div id="second">
					<form action="register.php" method="POST">
						<input type="text" name="reg_fname" placeholder="First Name" autofocus="" value="<?php 
